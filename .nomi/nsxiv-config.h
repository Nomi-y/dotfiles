...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#2a2422" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#b35a42" };
...
static const char *BAR_FONT[] = { "Nsxiv.bar.font",            "Jetbrains Mono-12" };
